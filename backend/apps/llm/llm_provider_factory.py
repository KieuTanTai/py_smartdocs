...
class LLMProviderFactory(ILLMProviderFactory):
    def __init__(self, model_name: EProviderName, logger: ILogger | None = None):
        self.provider = model_name.value
    ...
    def get_provider(self) -> ILLMClient:
        ...
        if self.provider == EProviderName.GEMINI.value:
        ...
        elif self.provider == EProviderName.MISTRAL.value:
        ...
        elif self.provider == EProviderName.OLLAMA.value:
