...
class ConversationModel(models.Model):
    conversation_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, db_column="conversations_id")
...
class MessageModel(models.Model):
    message_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, db_column="messages_id")
    conversation = models.ForeignKey(
