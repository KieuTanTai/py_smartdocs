...
`share` holds shared backend primitives used by the rest of the project:
...
- `backend/apps/share/api/views.py`
  - `HealthView`, `ProviderListView`, `ProviderTestView`
- `backend/apps/share/api/urls.py`
  - routes mounted under `/api/`
- `backend/apps/share/responses/builders.py`
  - `api_success()` and `api_error()`
- `backend/apps/share/exceptions/handlers.py`
  - DRF exception handler override
- `backend/apps/share/config/env.py`
  - small env helper
